...
export interface PersonaReply {
  ...
  promptSentenceAr?: string;
  targetSentenceHint?: string;
  expectedTargetSentence?: string;
...
export interface CorrectorMessage {
  ...
  text: string;
  timestamp: string;
  sendMode?: "correct" | "chat" | "persona" | "sentence_builder";
  personaId?: string;
  personaName?: string;
  aiModelName?: string;
...
export interface CorrectorSession {
  ...
  personaId?: string;
  chatType?: "free" | "exercise" | "sentence_builder";
